        ...
        <div class="container">
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <ol>
                    ...
                    <li><a href="#">Tambah Daftar Kepala Sekolah</a></li>
                </ol>
            </div>
    ...
    <section id="siswa" class="faq section-bg">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <form action="/adminHome/addKepsekHome/store" method="POST" class="col-8" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        @if ($errors->any())
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nama_kepsek" name="nama_kepsek" required>
                    </div>
                    <div class="form-group">
