    ...
    <section id="siswa" class="faq section-bg">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <form action="/updatestruktur/{{$struktur -> id}}" method="POST" class="col-8" enctype="multipart/form-data">
                    @method('put')
                    @csrf
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        <div class="form-group">
                            <label for="foto_org_sekolah">Struktur Organisasi</label>
                            <input type="file" name="foto_org_sekolah" class="form-control" id="foto_org_sekolah" value="{{$struktur -> foto_org_sekolah}}">
                        </div>
                        <hr>
                        <div>
